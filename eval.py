...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-64,5,T,oja,0.75,norm_pool_stdp-128,0.75_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-64,5,T,oja,0.905,norm_pool_stdp-128,0.905_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,3,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,7,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-16,5,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-64,5,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.25,uni_pool_stdp-128,0.25_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.368,uni_pool_stdp-128,0.368_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.5,uni_pool_stdp-128,0.5_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.75,uni_pool_stdp-128,0.75_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model = Sequence(
    ImageInput(shape=(1, 28, 28), step_count=20, batch_size=200),
    Stochastic(rng=rng),
    Conv2D(filter_count=32, filter_size=5, rng=rng, verbose=False, uniform_norm=True, euclid_norm=False, rule='oja', memory=0.905, conv_init=ConvInit.UNIFORM),
    Pool2D(verbose=False),
    STDP(neuron_count=128, rng=rng, verbose=False, memory=0.905),
    SVM(kernel='poly', degree=2),
)
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.905,uni_pool_stdp-128,0.905_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,1.0,uni_pool_stdp-128,1.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,F,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,oja,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,bcm,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model = Sequence(
    ImageInput(shape=(1, 28, 28), step_count=20, batch_size=200),
    Stochastic(rng=rng),
    Conv2D(filter_count=32, filter_size=5, rng=rng, verbose=False, uniform_norm=True, euclid_norm=False, rule='stdp', memory=0.0, conv_init=ConvInit.UNIFORM),
    Pool2D(verbose=False),
    STDP(neuron_count=128, rng=rng, verbose=False, memory=0.0),
    SVM(kernel='poly', degree=2),
)
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,stdp,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,uni_pool_stdp-64,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,uni_pool_stdp-256,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,uni_pool_conv-32,3,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,uni_pool_conv-32,5,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,uni_pool_conv-32,7,T,std,0.0,uni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,norm_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,gluni_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,glnorm_pool_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_stdp-128,0.0_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_conv-32,5,T,std,0.0,uni_pool_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
...
model.load(f"models/{dataset}-{TRAIN_SIZE},20,200_stoch_svm.npz")
out = model.predict(val_images)
print('accuracy:', accuracy_score(val_labels, out))
